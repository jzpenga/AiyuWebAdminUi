...
import {  ResponsiveContainer,ComposedChart,Line,Bar,
...
const AComposedChart = ({xName,dataKey,barLineName,dataSource}) => {
  ...
  return <ResponsiveContainer width="100%" height={config.chartOpt.chartHeight}>
    <ComposedChart data={dataSource} margin={ {top: 60, left: 5, right: 5, bottom: 5} }>
      ...
      <Bar name={barLineName[0]}  yAxisId="left" dataKey={dataKey[0]} barSize={20} fill={config.chartOpt.chartBar.color[1]}/>
      <Line name={barLineName[1]}  yAxisId="right" type='monotone' dataKey={dataKey[1]}
